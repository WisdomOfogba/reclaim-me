  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      ...
      if (!isGuided || JSON.parse(isGuided) !== true) {
        // setOpen(true);
        toast.info("Take a tour", {
          description: (
            <div>
              <span className="mb-2.5">Would you like a tour of the app</span>
              <div className="w-full flex gap-5 justify-center mt-2.5">
                {/* <Button
                variant="outline"
                className="py-2.5 px-5 dark:text-gray-300 dark:bg-red-600 dark:hover:bg-red-500"
                >
                CANCEL
                </Button> */}
              </div>
    ...
    <>
      {/* <Dialog open={open} modal={true}>
        <DialogContent className="max-w-[300px]">
          <DialogHeader>
            <DialogTitle className="mx-auto text-center mt-2.5 w-[200px]">
          ...
          <div className="w-full flex gap-5 justify-center mt-5">
            ...
            <Button
              variant="outline"
              className="py-2.5 px-5 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-slate-700"
            >
              OK
            </Button>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 py-12 lg:py-20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              >
                Got scammed online? You&apos;re not alone, and you&apos;re not
                powerless. ReclaimMe helps you fight back by turning your
                experience into ready-to-send reports, bank complaints, and
                action checklists.
              </motion.p>
          ...
          <AnimateWhenVisible>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Our AI-driven platform simplifies the process of reporting scams
              ...
              <Card className="border-2 hover:border-blue-200 pb-2 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-lg bg-white dark:bg-slate-900 border-gray-200 dark:border-gray-700 hover:scale-105">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-gray-600 dark:text-gray-300">
                    Advanced AI creates professional, legally-sound letters
                    tailored to your specific incident
                  </CardDescription>
                </CardHeader>
              </Card>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <Card className="border-2 hover:border-blue-200 pb-2 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-lg bg-white dark:bg-slate-900 border-gray-200 dark:border-gray-700 hover:scale-105">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-gray-600 dark:text-gray-300">
                    Full editing capabilities to personalize your letters and
                    add specific details about your case
                  </CardDescription>
                </CardHeader>
              </Card>
            </motion.div>
            ...
            >
              <Card className="border-2 hover:border-blue-200 pb-2 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-lg bg-white dark:bg-slate-900 border-gray-200 dark:border-gray-700 hover:scale-105">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-gray-600 dark:text-gray-300">
                    Preview your letters before sending via email or downloading
                    as PDF documents
                  </CardDescription>
                </CardHeader>
              </Card>
            ...
            <AnimateWhenVisible>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300">
                  Get professional legal documentation in just a few simple
                  steps
                </p>
              </div>
            </AnimateWhenVisible>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                    Join thousands of victims who have successfully reported
                    scams and recovered their losses
                  </p>
                  <Link href="/signup">
                    <motion.div
