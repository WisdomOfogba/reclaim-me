...
import { Shield, FileText, Mail, Edit, Eye, Users, Clock, CheckCircle, ArrowRight, Star } from "lucide-react"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              Get Justice with
              <span className="text-blue-600 dark:text-blue-400 block">AI-Generated Legal Letters</span>
            </h1>
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Our platform empowers scam victims to take action with professionally crafted letters for banks, law
              enforcement, and legal entities. Report incidents and get AI-assisted documentation in minutes.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-16">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">Letters Generated</p>
            </div>
            <div className="text-center">
