...
import { Shield, Mail, Lock, User, Eye, EyeOff, CheckCircle, ArrowRight } from "lucide-react"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:pr-8">
              <Badge className="mb-6 bg-blue-100 text-blue-800 hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-300">
                Join ScamGuard Today
              </Badge>
              <h1 className="text-3xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                Take Action Against
                <span className="text-blue-600 dark:text-blue-400 block">Scammers Today</span>
              </h1>
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Join thousands of victims who have successfully used our AI-powered platform to generate professional
                legal documents and seek justice.
              </p>
              ...
              <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
                <CardHeader>
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <CardTitle className="text-blue-800 dark:text-blue-300 text-lg">Secure & Confidential</CardTitle>
                      <CardDescription className="text-blue-700 dark:text-blue-400">
                        Your sensitive information is protected with enterprise-grade encryption.
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
            ...
            <div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        />
                        <label htmlFor="updates" className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                          Send me updates about new features and security tips (optional)
                        </label>
                      </div>
                    </div>
              ...
              <Alert className="mt-6 border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/20">
                ...
                <AlertDescription className="text-blue-700 dark:text-blue-400">
                  Your account will be secured with enterprise-grade encryption. We never share your personal
